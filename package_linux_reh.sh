...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:centos7-devtoolset8-${VSCODE_ARCH}"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:bionic-devtoolset-arm32v7"

  export VSCODE_SKIP_SYSROOT=1
  export USE_GNUPP2A=1
elif [[ "${VSCODE_ARCH}" == "ppc64le" ]]; then
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:bionic-devtoolset-ppc64le"

  export ELECTRON_SKIP_BINARY_DOWNLOAD=1
  export PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=1
  export VSCODE_SYSROOT_REPOSITORY='IDE123/vscode-linux-build-agent'
  export VSCODE_SYSROOT_VERSION='20240129-253798'
  export USE_GNUPP2A=1
elif [[ "${VSCODE_ARCH}" == "riscv64" ]]; then
  NODE_VERSION="20.16.0"
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:focal-devtoolset-riscv64"
  ...
  NODE_VERSION="20.16.0"
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:trixie-devtoolset-loong64"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="IDE123/IDE123-linux-build-agent:focal-devtoolset-s390x"
